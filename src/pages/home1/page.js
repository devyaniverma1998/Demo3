                ...
                <div id="carouselId" className="carousel slide" data-bs-ride="carousel">
                    ...
                    <div className="carousel-inner" role="listbox">
                        <div className="carousel-item active">
                            <img src="/carousel-3.jpg" className="img-fluid" alt="Image" />
                        ...
                        <div className="carousel-item">
                            <img src="/carousel-2.jpg" className="img-fluid" alt="Image" />
                            <div className="carousel-caption">
                                <div className="p-3" >
                                    <h4 className="text-primary text-uppercase mb-3" >Spa & Beauty Center</h4>
                        ...
                        <div className="carousel-item">
                            <img src="/carousel-1.jpg" className="img-fluid" alt="Image" />
                            <div className="carousel-caption">
                                <div className="p-3" >
                                    <h4 className="text-primary text-uppercase mb-3" >Spa & Beauty Center</h4>
