                            ...
                            <form>
                                <div className="row gy-3 gx-4">
                                    ...
                                    <div className="col-lg-12">
                                        <textarea className="form-control border-white bg-transparent text-white" name="text" id="area-text" cols="30" rows="5" placeholder="Write Comments"></textarea>
                                    </div>
                                    <div className="col-lg-12">
                ...
                <div className="container py-5">
                    <div className="row g-5 justify-content-center">
                                ...
                                <div className="counter-content bg-white p-4">
                                    ...
                                    <div className="svg-img">
                                        <svg width="100" height="50">
                                            <polygon points="55, 10 85, 55 25, 55 25," />
                                        </svg>
                                    </div>
                                </div>
                        ...
                        <div className="col-md-6 col-lg-4 col-xl-4">
                            <div className="counter-item p-5">
                                <div className="counter-content bg-white p-4">
                                    <i className="fas fa-spa fa-5x text-primary mb-3"></i>
